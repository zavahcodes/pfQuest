local locales = {
  ...
  ["Quest Tracker Text Outline"] = "Contorno de Texto no Rastreador",
    ...
    ["Show Quest Info On NPC Tooltips"] = "Mostrar Informações de Missão em Dicas de NPCs",
  ...
  ["esES"] = {
    ...
    ["Show Database Results"] = nil,
    ["Show Help On Tooltips"] = nil,
    ["Show Quest Info On NPC Tooltips"] = "Mostrar Info de Misiones en Tooltips de NPCs",
    ["Show herbs with an appropriate skill level for your character"] = nil,
    ["Show herbs with skill range of [min] to [max]"] = nil,
    ["Show Level On Quest Log"] = nil,
    ["Show Level On Quest Tracker"] = nil,
