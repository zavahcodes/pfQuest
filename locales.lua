local locales = {
  ...
  ["Quest Tracker Text Outline"] = "Contorno de Texto no Rastreador",
    ...
    ["Resynchronize Quests"] = "Resincronizar Missões",
    ["Resynchronizing quests with server..."] = "Resincronizando missões com o servidor...",
    ["Quest resynchronization is not available on this server."] = "A resincronização de missões não está disponível neste servidor.",
    ...
    ["Hide Accepted Quest Info On NPC Tooltips"] = "Ocultar Informações de Missões Aceitas em Dicas de NPCs",
  ...
  ["Show Quest Starters (Mini Map)"] = "Mostrar Iniciadores de Missão (Minimapa)",
  ["Show Quest Enders (Mini Map)"] = "Mostrar Finalizadores de Missão (Minimapa)",
  ["Show Quest Starters (World Map)"] = "Mostrar Iniciadores de Missão (Mapa-Múndi)",
  ["Show Quest Enders (World Map)"] = "Mostrar Finalizadores de Missão (Mapa-Múndi)",
  ["Disable World Map Node Interaction (Hold Shift to override)"] = "Desabilitar Interação de Nós do Mapa-Múndi (Segure Shift para anular)",
  ["Disable Minimap Node Interaction (Hold Shift to override)"] = "Desabilitar Interação de Nós do Minimapa (Segure Shift para anular)",
  ...
  ["Show Quest Starters (Mini Map)"] = "Mostrar iniciadores de misión (minimapa)",
  ["Show Quest Enders (Mini Map)"] = "Mostrar finalizadores de misión (minimapa)",
  ["Show Quest Starters (World Map)"] = "Mostrar iniciadores de misión (mapa del mundo)",
  ["Show Quest Enders (World Map)"] = "Mostrar finalizadores de misión (mapa del mundo)",
  ["Disable World Map Node Interaction (Hold Shift to override)"] = "Desactivar interacción de nodos del mapa del mundo (Mantén Shift para anular)",
  ["Disable Minimap Node Interaction (Hold Shift to override)"] = "Desactivar interacción de nodos del minimapa (Mantén Shift para anular)",
  ...
  ["Show Quest Starters (Mini Map)"] = "显示任务起始者(小地图)",
  ["Show Quest Enders (Mini Map)"] = "显示任务终结者(小地图)",
  ["Show Quest Starters (World Map)"] = "显示任务起始者(世界地图)",
  ["Show Quest Enders (World Map)"] = "显示任务终结者(世界地图)",
  ["Disable World Map Node Interaction (Hold Shift to override)"] = "禁用世界地图节点交互(按住Shift键覆盖)",
  ["Disable Minimap Node Interaction (Hold Shift to override)"] = "禁用小地图节点交互(按住Shift键覆盖)",
  ...
  ["esES"] = {
    ...
    ["Reset Map"] = nil,
    ["Reset Quest History"] = nil,
    ["Resynchronize Quests"] = "Resincronizar Misiones",
    ["Resynchronizing quests with server..."] = "Resincronizando misiones con el servidor...",
    ["Quest resynchronization is not available on this server."] = "La resincronización de misiones no está disponible en este servidor.",
    ["Respawn"] = nil,
    ...
    ["Show Database Results"] = nil,
    ["Show Help On Tooltips"] = nil,
    ["Hide Accepted Quest Info On NPC Tooltips"] = "Ocultar Info de Misiones Aceptadas en Tooltips de NPCs",
    ["Show herbs with an appropriate skill level for your character"] = nil,
    ["Show herbs with skill range of [min] to [max]"] = nil,
    ["Show Level On Quest Log"] = nil,
    ["Show Level On Quest Tracker"] = nil,
  ...
  ["Show Quest Starters (Mini Map)"] = "Показывать начинающих квест (миникарта)",
  ["Show Quest Enders (Mini Map)"] = "Показывать завершающих квест (миникарта)",
  ["Show Quest Starters (World Map)"] = "Показывать начинающих квест (карта мира)",
  ["Show Quest Enders (World Map)"] = "Показывать завершающих квест (карта мира)",
  ["Disable World Map Node Interaction (Hold Shift to override)"] = "Отключить взаимодействие с узлами карты мира (удерживайте Shift для отмены)",
  ["Disable Minimap Node Interaction (Hold Shift to override)"] = "Отключить взаимодействие с узлами миникарты (удерживайте Shift для отмены)",
