...
pfQuest_defconfig = {
  ...
  { text = L["Hide Accepted Quest Info On NPC Tooltips"],
    default = "0", type = "checkbox", config = "npctooltips" },
  ...
  { text = L["Quest Tracker Text Outline"],
    default = "0", type = "checkbox", config = "trackeroutline" },
  { text = L["Quest Tracker Unfold Objectives"],
    default = "0", type = "checkbox", config = "trackerexpand" },

  { text = (L["Map"] or L["Map & Minimap"] or "Map"),
    default = nil, type = "header" },
  ...
  { text = L["Disable World Map Node Tooltips"],
    default = "0", type = "checkbox", config = "disablemouseovermap" },
  { text = L["Disable World Map Node Interaction (Hold Shift to override)"],
    default = "0", type = "checkbox", config = "disablemapmouse" },
  { text = L["Show Quest Starters (World Map)"],
    default = "1", type = "checkbox", config = "showqstartersworld" },
  { text = L["Show Quest Enders (World Map)"],
    default = "1", type = "checkbox", config = "showqendersworld" },
  ...
  { text = (L["Minimap"] or L["Map & Minimap"] or "Minimap"),
    default = nil, type = "header" },
  ...
  { text = L["Disable Minimap Node Tooltips"],
    default = "0", type = "checkbox", config = "disablemouseovermini" },
  { text = L["Disable Minimap Node Interaction (Hold Shift to override)"],
    default = "0", type = "checkbox", config = "disableminimapmouse" },
